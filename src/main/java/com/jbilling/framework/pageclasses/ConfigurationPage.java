...
public class ConfigurationPage {
	...
	@LocateBy(xpath = "//a[contains(text(),'Account Type')]")
	private ElementField ACCOUNT_TYPE_LINK;

	@LocateBy(xpath = "//div[@id='left-column']/div/ul//li//a[contains(text(),'Account Type')]")
	...
	@LocateBy(xpath = "	//div[@id='viewport']/div/div/div/table/thead/tr/th[1]")
	private ElementField PREFERENCE;

	@LocateBy(xpath = "	//div[@id='column2']/div/divstrong")
	private ElementField PREFERENCE63;
	...
	public ConfigurationPage selectAccountTypeName(String accountTypeName) throws Exception {
		GlobalController.brw.clickTableCellWithText(this.TAB_ACCOUNT_TYPES_NAMES, accountTypeName);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	...
	public ConfigurationPage clickOnAccountTypeLink() throws Exception {
		GlobalController.brw.click(this.ACCOUNT_TYPE_LINK);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	...
	protected ConfigurationPage selectUsagePoolConsumptionNotification(String usagePoolConsumptionNotification) throws Exception {
		...
		GlobalController.brw.waitForElement(this.DD_usagePoolConsumptionNotification_Invoice, 1000);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	...
	protected ConfigurationPage selectusagePoolConsumptionNotification_Invoice(String usagePoolConsumptionNotification_Invoice)
		...
		GlobalController.brw.waitForElement(this.DD_usagePoolConsumptionNotification_Invoice_mail, 1000);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	...
	public ConfigurationPage selectUsagePoolName100Calls(String testDataSetName, String category) throws Exception {

		String usagePoolName = TestData.read("PageConfiguration.xml", testDataSetName, "notification", category);
	...
	public ConfigurationPage validateAccountInformationTypeSavedTestData(String data) throws Exception {
		GlobalController.brw.validateSavedTestData(this.TAB_ACCOUNT_TYPES_LIST_NAMES, data);
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	...
	public ConfigurationPage ClickOnMetaFieldBar() throws Exception {
		GlobalController.brw.waitForElement(this.METAFIELD_BAR, 5000);
	...
	public ConfigurationPage SelectPaymentMethodTemplate(String testDataSetName, String category) throws Exception {
		...
		this.clickAddNewButton();
		GlobalController.brw.waitForElement(this.DD_PAYMENTTEMPLATE, 9000);
		this.selectPaymentTemplate(paymentTemplate);
		this.clickSelectButton();
		return GlobalController.brw.initElements(ConfigurationPage.class);
	}
	...
	public String addAnotherAITMetaFiledToExistingAccountType(String testDataSetName, String category, String accountType) throws Exception {
	...
	public ConfigurationPage changeJQGridForTables(String testDataSetName, String category) throws Exception {

		String Value = TestData.read("PageConfiguration.xml", testDataSetName, "Value", category);

		GlobalController.brw.click(this.LT_JQGRIDFORTABLES);
		GlobalController.brw.clearTextBox(this.TB_CONFIGURATION_PREFERENCE_VALUE);
		GlobalController.brw.setText(this.TB_CONFIGURATION_PREFERENCE_VALUE, Value);
		this.clickSaveChangesButton();
	...
	public ConfigurationPage selectJQGridForTables() throws Exception {

		try {
			String displayedText = GlobalController.brw.getText(this.PREFERENCE);
			String expectedText = "Preference";
			if (displayedText.contains(expectedText)) {
				ConfigurationPage.logger.info(this.PREFERENCE + "is Visible");
			} else {
				ConfigurationPage.logger.info(this.PREFERENCE + "is not Visible");
				throw new Exception();
			}
		} catch (Exception e) {
			ConfigurationPage.logger.info(e);
		...
		GlobalController.brw.click(this.LT_USEJQGRIDFORTABLES);

		try {
			String displayedTexts = GlobalController.brw.getText(this.PREFERENCE63);
			String expectedTexts = "Preference 63";
			if (displayedTexts.contains(expectedTexts)) {
				ConfigurationPage.logger.info(this.PREFERENCE63 + "is Visible");
			} else {
				ConfigurationPage.logger.info(this.PREFERENCE63 + "is not Visible");
				throw new Exception();
			}
		} catch (Exception e) {
			ConfigurationPage.logger.info(e);
	...
	public ConfigurationPage enterValueInJQGrid(String testDataSetName, String category) throws Exception {
		String Value = TestData.read("PageConfiguration.xml", testDataSetName, "Value", category);
