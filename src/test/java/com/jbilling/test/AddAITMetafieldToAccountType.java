...
public class AddAITMetafieldToAccountType extends BrowserApp {
	...
	public void addAITMetafieldToAccountType() throws Exception {
		...
		AddAITMetafieldToAccountType.logger.debug("Add Metafield to an Account Type");
		...
		AddAITMetafieldToAccountType.logger.debug("VAlidate metaield in an account information type");
