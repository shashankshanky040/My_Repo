...
public class ProductsPage {
	...
	@LocateBy(xpath = "//select[@id='parentItemTypeId']/option")
	...
	private ElementField CB_ALLOW_ASSERT_MANAGEMENT;
	...
	@LocateBy(xpath = "//table[@id='products']//tbody//tr//td")
	private ElementField TABLE_PRODUCT;

	@LocateBy(xpath = "//table[@id='users']//tbody//tr//td")
	...
	@LocateBy(xpath = "//table[@class='dataTable']/tbody/tr/td")
	...
	ProductsPage checkAssetManagement(Boolean assetManage) throws Exception {
		if (assetManage) {
			GlobalController.brw.check(this.CB_ALLOW_ASSERT_MANAGEMENT);
		} else {
			GlobalController.brw.uncheck(this.CB_ALLOW_ASSERT_MANAGEMENT);
		}
		return GlobalController.brw.initElements(ProductsPage.class);
	...
	public String addProduct(AddProductField addProductField, String testDataSetName, String category) throws Exception {
		...
		case FLAT:
			...
			// this.enableAllowAssetMgmtCheckBox(assetManage);
	...
	public ProductsPage addProductCategoryWithAssetMgmt(setProductCategoryWithAssetMgmt addProductCategory, String testDataSetName,
		...
		String parentCompanyValue = TestData.read("PageProducts.xml", testDataSetName, "parentCompanyValue", category);
		...
		String ImportMetaFieldValue = TestData.read("PageProducts.xml", testDataSetName, "ImportMetaFieldValue", category);
		String ImportMetaFieldValue2 = TestData.read("PageProducts.xml", testDataSetName, "ImportMetaFieldValue", category);
		...
		case PCWAMG2:
			this.clickAddProductCategory();
			this.setProductCategoryName(assetCategory);
			this.selectParentCompany(parentCompanyValue);
			this.selectCurrentCompany();
			this.checkAllowAssetManagement();
			...
			this.selectImportMetaField(ImportMetaFieldValue);
			this.clickMetaField();
		...
		case PCWAMG3:
			...
			this.setAssetStatusName(assetStatusName3);
			this.checkOrderSave();
			this.selectImportMetaField(ImportMetaFieldValue2);
			this.clickMetaField();
			this.clickSaveCategory();
			break;
	 ...
	 * @throws Exception
	 */
	ProductsPage enableGlobleCheckBox(boolean globle) throws Exception {
		if (globle) {
	...
	public String addNewCategory(String testDataSetName, String category) throws Exception {
		...
		this.checkAssetManagement(assetCheckBox);
		this.enableGlobleCheckBox(globle);
		this.checkAvailable();
		this.checkDefault();
	...
	/*
	 * public ProductsPage addProduct() throws Exception { //String pricingModel
	 * = TestData.read("PageProducts.xml", testDataSetName, "pricingModel",
	 * category);
	 * 
	 * this.clickAddProduct(); this.verifyDescriptionSelectValue("English");
	 * this.selectAddDescription("English"); this.clickonDescriptionPlusIcon();
	 * this.enterDescription("productDescription", "name");
	 * this.setProductCode("SIM"); this.enableGlobleCheckBox();
	 * this.enableAllowAssetMgmtCheckBox(); this.selectPricingModel("Flat");
	 * 
	 * return GlobalController.brw.initElements(ProductsPage.class); }
	 */
	...
	public ProductsPage ClickOnAddedCategory() throws Exception {
		GlobalController.brw.clickLinkText(this.TABLE_CATEGORY);
		return GlobalController.brw.initElements(ProductsPage.class);
	}
	...
	public ProductsPage EditProducts(String product_category, String testDataSetName1, String category, String product_category2)
		...
		boolean flag = false;
		GlobalController.brw.waitForElement(this.TEXT_LEMONADE, 8000);
		...
		GlobalController.brw.waitForElement(this.TEXT_COFFEE, 8000);
	 ...
	 * @throws Exception
	 */
	protected ProductsPage selectParentCompany(String parentCompanyValue) throws Exception {
		GlobalController.brw.selectListItem(this.Dropdown_AddParentCategory, parentCompanyValue);
		return GlobalController.brw.initElements(ProductsPage.class);
